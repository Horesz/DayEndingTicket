...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-6">
    ...
    <!-- Fejléc / Hero rész – dashboard stílusban -->
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-8">
        <div class="p-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                @can('create', App\Models\Napzaras::class)
    ...
    <!-- Szűrők – dashboardhoz hasonló kártyában -->
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Fiók</th>
                    ...
                    @forelse($napzarasok as $nz)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium text-gray-900">
                                {{ number_format($nz->kartya_bevetel + $nz->keszpenz_bevetel + $nz->online_bevetel + $nz->egyeb_bevetel, 0, ',', ' ') }} Ft
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-bold text-gray-900">
                                {{ number_format(
                                    ($nz->kartya_bevetel + $nz->keszpenz_bevetel + $nz->online_bevetel + $nz->egyeb_bevetel)
                                    - ($nz->napi_ber + $nz->koltsegek), 0, ',', ' '
                                ) }} Ft
                            </td>
